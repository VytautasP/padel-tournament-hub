 ...
 * thing on the share sheet that can fail to arrive (ADR-0026 §4); and the build reload, which is
 * how a tab that missed a deploy gets onto the current build instead of being told it is offline
 * (ADR-0030). Nothing else in the app knows which implementation it got.
 *
